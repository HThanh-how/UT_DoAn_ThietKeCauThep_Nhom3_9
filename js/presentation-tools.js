...
(function () {
    ...
    const chapters = [
        ...
        { num: 1, title: 'Cơ sở thiết kế', color: '#005ce6', slideFile: '01_basis.html' },
        { num: 2, title: 'Kết cấu nhịp', color: '#10b981', slideFile: '04_girder.html' },
        { num: 3, title: 'Nội lực & cấu tạo', color: '#8b5cf6', slideFile: '07_actions.html' },
        { num: 4, title: 'Kiểm toán & kết luận', color: '#0ea5e9', slideFile: '10_verification.html' },
    ];
